var info = (function () {
                ...
                $.each(featureInfoByLayer, function (index, response) {
                    ...
                    switch (contentType.split(";")[0]) {
                        ...
                        case "application/vnd.esri.wms_featureinfo_xml":
                            ...
                            break;
                        default :
                            mviewer.alert("Ce format de r̩ponse : " + contentType +" n'est pas pris en charge", "alert-warning");
                    }
                    if (html) {
                        //test si pr̩sence d'une classe .feature eg template geoserver.
                        //Chaque ̩l̩ment trouv̩ est une feature avec ses propri̩t̩s
    ...
    var toggleTooltipLayer =  function (el) {
        ...
        if ( a.find("input").val() === 'false' ) {
            //On d̩sactive l'ancien tooltip
