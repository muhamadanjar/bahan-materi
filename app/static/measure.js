var measure = (function () {
    ...
    var _pointerMoveHandler = function(evt) {
        ...
        /** @type {string} */
        var helpMsg = 'Cliquer pour d̩buter la mesure';
        if (_sketch) {
    ...
    var _toggle = function () {
        if (_modMeasureEnabled) {
            app.unsetTool('measure');
        } else {
            app.setTool('measure', 'LineString');
        }
    };
    ...
    var _initMeasureTool = function () {
        _map = app.getMap();
        _projection = app.getProjection().getCode();
        ...
        var button = [
            '<button class="mv-modetools btn btn-default btn-raised" href="#"',
                ' onclick="app.tools.measure.toggle();" id="measurebtn" title="Mesurer" i18n="measure.button.main"',
        ...
        var buttonoptions = [
            '<div id="drawtoolsoptions" style="display:none;" class="btn-group btn-group-sm"',
                ...
                '<button  id="measurelinebtn" title="Mesure lin̩aire" i18n="measure.button.line"',
                    ' onclick="app.setTool(\'measure\', \'LineString\');" class="btn btn-default button-tools" >',
                    '<span class="glyphicon glyphicon-resize-small" aria-hidden="true"></span>',
                '</button>',
                '<button  id="measureareabtn" title="Mesure surfacique" i18n="measure.button.surface" onclick="app.setTool(\'measure\', \'Polygon\');"',
